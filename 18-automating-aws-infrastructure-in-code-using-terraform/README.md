...
+ we will do the same to `cidr` value in the `vpc` and all other arguments
...
Availability zones from AWS, and replace the hard coded value in the subnet's `availability_zone` section.
